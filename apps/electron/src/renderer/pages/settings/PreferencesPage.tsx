 ...
 * PreferencesPage
 *
 * Form-based editor for stored user preferences (~/.pmi-agent/preferences.json).
 * Features:
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 min-h-0 mask-fade-y">
        <ScrollArea className="h-full">
          ...
          <SettingsSection
            title="Basic Info"
            description="Help PMI Agent personalize responses to you."
          >
            <SettingsCard divided>
              <SettingsInput
                label="Name"
                description="How PMI Agent should address you."
              ...
              <SettingsInput
                label="Language"
                description="Preferred language for PMI Agent's responses."
          ...
          <SettingsSection
            title="Notes"
            description="Free-form context that helps PMI Agent understand your preferences."
            action={
          ...
          >
            <SettingsCard divided={false}>
              <SettingsTextarea
                ...
                placeholder="Any additional context you'd like PMI Agent to know..."
                rows={5}
                inCard
              />
            </SettingsCard>
