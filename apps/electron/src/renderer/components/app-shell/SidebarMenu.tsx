...
import { getDocUrl, type DocFeature } from '@pmi-agent/shared/docs/doc-links'
...
export function SidebarMenu({
  ...
  if (type === 'newChat') {
    return (
      <MenuItem onClick={() => window.electronAPI.openUrl('pmiagent://action/new-chat?window=focused')}>
