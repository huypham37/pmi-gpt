...
import type { Session, Message, FileAttachment, StoredAttachment, PermissionRequest, CredentialRequest, CredentialResponse, LoadedSource, LoadedSkill, AgentProfile } from "../../../shared/types"
...
import { TurnCard, UserMessageBubble, groupMessagesByTurn, formatTurnAsMarkdown, formatActivityAsMarkdown, type Turn, type AssistantTurn, type UserTurn, type SystemTurn, type AuthRequestTurn } from "@pmi-agent/ui"
...
import { flattenLabels } from "@pmi-agent/shared/labels"
...
interface ChatDisplayProps {
  ...
  labels?: import('@pmi-agent/shared/labels').LabelConfig[]
...
export const ChatDisplay = React.forwardRef<ChatDisplayHandle, ChatDisplayProps>(function ChatDisplay({
  ...
  // These settings are stored in ~/.pmi-agent/preferences.json (not localStorage)
  ...
  // Uses the shared extractOverlayData parser from @pmi-agent/ui
