 ...
 * - Location: Default (~/.pmi-agent/workspaces/) or Custom
 */
export function AddWorkspaceStep_CreateNew({
  ...
  const defaultBasePath = homeDir ? `${homeDir}/.pmi-agent/workspaces` : '~/.pmi-agent/workspaces'
      ...
      <div className="mt-6 w-full space-y-6">
        ...
        <div className="space-y-3">
          ...
          <AddWorkspace_RadioOption
            ...
            subtitle="under .pmi-agent folder"
          />
