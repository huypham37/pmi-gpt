 ...
 * Includes only relevant items for the PMI Agent app.
 *
...
export async function rebuildMenu(): Promise<void> {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    ...(isMac ? [{
      label: 'PMI Agent',
      submenu: [
        { role: 'about' as const, label: 'About PMI Agent' },
        updateMenuItem,
        ...
        { type: 'separator' as const },
        { role: 'hide' as const, label: 'Hide PMI Agent' },
        { role: 'hideOthers' as const },
        { role: 'unhide' as const },
        { type: 'separator' as const },
        { role: 'quit' as const, label: 'Quit PMI Agent' }
      ]
    }] : []),
