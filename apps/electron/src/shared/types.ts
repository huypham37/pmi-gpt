...
// Core types are re-exported from @pmi-agent/core
...
import type { PermissionMode } from '@pmi-agent/shared/agent/modes';
export type { PermissionMode };
export { PERMISSION_MODE_CONFIG } from '@pmi-agent/shared/agent/modes';

// Import thinking level types
import type { ThinkingLevel } from '@pmi-agent/shared/agent/thinking-levels';
export type { ThinkingLevel };
export { THINKING_LEVELS, DEFAULT_THINKING_LEVEL } from '@pmi-agent/shared/agent/thinking-levels';
...
import type { AuthState, SetupNeeds } from '@pmi-agent/shared/auth/types';
import type { AuthType } from '@pmi-agent/shared/config/types';
export type { AuthState, SetupNeeds, AuthType };

// Import agent profile type
import type { AgentProfile } from '@pmi-agent/shared/sessions/types';
export type { AgentProfile };

// Import source types for session source selection
import type { LoadedSource, FolderSourceConfig, SourceConnectionStatus } from '@pmi-agent/shared/sources/types';
export type { LoadedSource, FolderSourceConfig, SourceConnectionStatus };

// Import skill types
import type { LoadedSkill, SkillMetadata } from '@pmi-agent/shared/skills/types';
...
import type { AuthRequest as SharedAuthRequest, CredentialInputMode as SharedCredentialInputMode, CredentialAuthRequest as SharedCredentialAuthRequest } from '@pmi-agent/shared/agent';
...
export { generateMessageId } from '@pmi-agent/core/types';
...
export type { PermissionRequest as BasePermissionRequest } from '@pmi-agent/core/types';
import type { PermissionRequest as BasePermissionRequest } from '@pmi-agent/core/types';
...
// CredentialInputMode is imported from @pmi-agent/shared/agent above
...
import type { Message } from '@pmi-agent/core/types';
...
export type SessionEvent =
  ...
  | { type: 'tool_start'; sessionId: string; toolName: string; toolUseId: string; toolInput: Record<string, unknown>; toolIntent?: string; toolDisplayName?: string; toolDisplayMeta?: import('@pmi-agent/core').ToolDisplayMeta; turnId?: string; parentToolUseId?: string }
...
export interface SendMessageOptions {
  ...
  badges?: import('@pmi-agent/core').ContentBadge[]
}
...
export const IPC_CHANNELS = {
  ...
  // Deep link navigation (main → renderer, for external pmiagent:// URLs)
  ...
  // Default permissions from ~/.pmi-agent/permissions/default.json
...
import type { Workspace, SessionMetadata, StoredAttachment as StoredAttachmentType } from '@pmi-agent/core/types';
...
export interface ElectronAPI {
  ...
  // Deep link navigation listener (for external pmiagent:// URLs)
  ...
  getSourcePermissionsConfig(workspaceId: string, sourceSlug: string): Promise<import('@pmi-agent/shared/agent').PermissionsConfigFile | null>
  getWorkspacePermissionsConfig(workspaceId: string): Promise<import('@pmi-agent/shared/agent').PermissionsConfigFile | null>
  getDefaultPermissionsConfig(): Promise<{ config: import('@pmi-agent/shared/agent').PermissionsConfigFile | null; path: string }>
  ...
  listStatuses(workspaceId: string): Promise<import('@pmi-agent/shared/statuses').StatusConfig[]>
  ...
  listLabels(workspaceId: string): Promise<import('@pmi-agent/shared/labels').LabelConfig[]>
  createLabel(workspaceId: string, input: import('@pmi-agent/shared/labels').CreateLabelInput): Promise<import('@pmi-agent/shared/labels').LabelConfig>
  ...
  listViews(workspaceId: string): Promise<import('@pmi-agent/shared/views').ViewConfig[]>
  saveViews(workspaceId: string, views: import('@pmi-agent/shared/views').ViewConfig[]): Promise<void>
