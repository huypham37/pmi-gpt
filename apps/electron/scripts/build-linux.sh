...
echo "=== Building PMI Agent AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: PMI-Agent-x86_64.AppImage or PMI-Agent-aarch64.AppImage
BUILT_APPIMAGE_NAME="PMI-Agent-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: PMI-Agent-x64.AppImage, PMI-Agent-arm64.AppImage
APPIMAGE_NAME="PMI-Agent-${ARCH}.AppImage"
