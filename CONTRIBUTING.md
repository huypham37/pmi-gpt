# Contributing to PMI Agent

Thank you for your interest in contributing to PMI Agent! This document provides guidelines and instructions for contributing.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/lukilabs/pmi-agents-oss.git
   cd pmi-agents-oss
   ```
...
└── packages/
    ├── core/        # @pmi-agent/core - Shared types
    ├── shared/      # @pmi-agent/shared - Business logic
    └── ui/          # @pmi-agent/ui - React components
```
