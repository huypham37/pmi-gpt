 ...
 *
 * File locations:
 * - Workspace: ~/.pmi-agent/workspaces/{slug}/permissions.json
 * - Per-source: ~/.pmi-agent/workspaces/{slug}/sources/{sourceSlug}/permissions.json
 *
 ...
 * Default permissions are stored at ~/.pmi-agent/permissions/
 */
...
/**
 * Load default permissions from ~/.pmi-agent/permissions/default.json
...
class PermissionsConfigCache {
  ...
  // App-level default permissions (loaded from ~/.pmi-agent/permissions/default.json)
   ...
   * These come from ~/.pmi-agent/permissions/default.json
   */
