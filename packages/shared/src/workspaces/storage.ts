 ...
 * Default location: ~/.pmi-agent/workspaces/
 */
...
/**
 * Get the default workspaces directory (~/.pmi-agent/workspaces/)
 */
 ...
 * @param baseDir - Parent directory where workspace folders live (e.g., ~/.pmi-agent/workspaces/)
 ...
 * Returns paths to valid workspaces found in ~/.pmi-agent/workspaces/
 */
