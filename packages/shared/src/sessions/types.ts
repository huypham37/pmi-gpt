...
import type { StoredAttachment, MessageRole, ToolStatus, AuthRequestType, AuthStatus, CredentialInputMode, StoredMessage } from '@pmi-agent/core/types';
 ...
 * Re-exported from @pmi-agent/core for convenience
 */
export type { StoredMessage } from '@pmi-agent/core/types';
...
export interface SessionHeader {
  ...
  /** SDK session ID (captured after first message) */
  sdkSessionId?: string;
  /** Workspace root path (stored as portable path, e.g., ~/.pmi-agent/...) */
  workspaceRootPath: string;
  /** Optional user-defined name */
  name?: string;
  createdAt: number;
