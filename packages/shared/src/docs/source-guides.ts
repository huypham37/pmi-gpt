 ...
 * Guides are now served exclusively via the pmi-agents-docs MCP server.
 *
 ...
 * Use the pmi-agents-docs MCP server to search for setup guides.
 *
 * Example: mcp__pmi-agents-docs__SearchCraftAgents({ query: "github source setup guide" })
 */
